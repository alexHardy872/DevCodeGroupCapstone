...
INSERT INTO [dbo].[TeacherPreferences] ([TeacherPreferenceId], [defaultLessonLength], [perHourRate], [distanceType], [maxDistance], [incrementalCost], [TimeBeforeCancellation], [teacherId], [NumberOfProximalLessons]) VALUES (1, 60, 7.77, 0, 5, CAST(0.25 AS Decimal(18, 2)), 24, 1, 0)
